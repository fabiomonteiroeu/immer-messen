...
const galleryHtml = `
  <p><img src="https://images.unsplash.com/photo-1605000797499-95a51c5269ae?auto=format&fit=crop&w=800&q=80" alt="" /></p>
  <p><img src="https://images.unsplash.com/photo-1473773508845-188df298d2d1?auto=format&fit=crop&w=800&q=80" alt="" /></p>
  <p><img src="https://images.unsplash.com/photo-1518709268805-4e9042af9f23?auto=format&fit=crop&w=800&q=80" alt="" /></p>
`;
...
const casesPt: CmsCase[] = [
  {
    ...
    body: `
      ...
      ${galleryHtml}
      <p>A integracao com a infraestrutura existente foi um dos pontos-chave do projeto. A fibra optica usada para monitoramento e a mesma ja instalada na operacao - sem necessidade de duplicacao, escavacao ou substituicao. O interrogador DATS realizou medicoes simultaneas de DAS e DTS, entregando informacao acustica e termica sobre o mesmo cabo.</p>
      <p><img src="https://images.unsplash.com/photo-1605000797499-95a51c5269ae?auto=format&fit=crop&w=1800&q=80" alt="" /></p>
      <p>Os dados gerados pelo sistema alimentam dashboards operacionais customizados, permitindo analises de tendencia, correlacao com variaveis externas e geracao de evidencias para auditoria. A escalabilidade da arquitetura permite estender o monitoramento para outros trechos com minimo investimento incremental.</p>
      ${galleryHtml}
    `,
  },
  {

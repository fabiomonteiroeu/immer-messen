...
const caseStudyDefs = [
  {
    ...
    "pt-BR": {
      ...
      results: "<p>Redução de tempo de resposta em até 80% frente a inspeções tradicionais e construção de base de conhecimento para futuras expansões.</p>",
      body: "<p>Projeto de validação técnica com foco em monitoramento contínuo, localização precisa de eventos e integração com processos operacionais.</p>",
    ...
    en: {
      ...
      solution: "<p>Immer Messen applied phase-based DAS technology along the entire asset, integrating events into the customer's operational environment.</p>",
      results: "<p>Up to 80% reduction in response time compared with traditional inspections and a knowledge base built for future expansions.</p>",
      body: "<p>Technical validation project focused on continuous monitoring, precise event localization and integration with operational processes.</p>",
  ...
  },
  {
    ...
    "pt-BR": {
      ...
      results: "<p>Maior cobertura observacional e consolidação de referência técnica para aplicações ambientais offshore.</p>",
      body: "<p>Projeto com foco em impacto ambiental, catalogação de padrões e suporte a estudos técnicos marinhos.</p>",
    ...
    en: {
      ...
      solution: "<p>Use of DAS to classify acoustic patterns and structure alerts for the technical team.</p>",
      results: "<p>Greater observational coverage and a consolidated technical reference for offshore environmental applications.</p>",
      body: "<p>Project focused on environmental impact, pattern cataloging and support for marine technical studies.</p>",
  ...
  },
  {
    ...
    "pt-BR": {
      ...
      solution: "<p>Uso de DAS ao longo da infraestrutura existente com classificação de eventos e correlação espacial.</p>",
      results: "<p>Melhor previsibilidade operacional e cobertura permanente sem patrulhamento físico constante.</p>",
      body: "<p>Case voltado à infraestrutura energética com forte dependência de detecção de eventos lineares e resposta coordenada.</p>",
    ...
    en: {
      ...
      solution: "<p>Use of DAS along the existing infrastructure with event classification and spatial correlation.</p>",
      results: "<p>Better operational predictability and permanent coverage without constant physical patrols.</p>",
      body: "<p>Case targeting energy infrastructure with strong dependence on linear event detection and coordinated response.</p>",
  ...
  },
  {
    ...
    "pt-BR": {
      ...
      results: "<p>Mais rapidez na resposta e base técnica para expandir monitoramento a novos trechos com menor investimento incremental.</p>",
      body: "<p>Projeto de observabilidade operacional para dutos terrestres com foco em segurança, integridade e continuidade.</p>",
    ...
    en: {
      ...
      solution: "<p>The DATS platform combines distributed reading, noise filtering and operational alerts with precise localization.</p>",
      results: "<p>Faster response and a technical foundation to extend monitoring to new sections with lower incremental investment.</p>",
      body: "<p>Operational observability project for onshore pipelines focused on safety, integrity and continuity.</p>",
    ...
    es: {
      ...
      solution: "<p>La plataforma DATS combina lectura distribuida, filtrado de ruido y alertas operativas con localización precisa.</p>",
      results: "<p>Mayor rapidez en la respuesta y una base técnica para extender el monitoreo a nuevos tramos con menor inversión incremental.</p>",
      body: "<p>Proyecto de observabilidad operativa para ductos terrestres enfocado en seguridad, integridad y continuidad.</p>",
...
const caseStudies = caseStudyDefs.flatMap((def) =>
  locales.map((locale) => ({
    ...
    data: {
      ...
      solution: def[locale].solution,
      results: def[locale].results,
      body: def[locale].body,
      seo: seo(
        def[locale].seoTitle,
        def[locale].seoDescription,
